...
const page = async ({
    ...
    const video_id = data.intro_url.split("v=")[1];

    return (
        <div className="grid lg:grid-cols-[2fr,1fr] gap-10 min-h-screen lg:mt-20">
            <div>
                <div className="relative aspect-video mb-5 ">
                    {data.intro_url ? (
                        <>
                            <iframe width="1046" height="588" src={`https://www.youtube.com/embed/${video_id}`} title="" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" className="w-full h-full object-fill"></iframe>
                        </>
                    ) : (
                        <Image
